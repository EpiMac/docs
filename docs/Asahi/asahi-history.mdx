...
Asahi Linux is a community-driven project with an ambitious goal: to enable the Linux operating system to function seamlessly on Apple's ARM-based hardware, including the latest Macs powered by Apple Silicon.
...
The Asahi Linux project is led by a group of 6 persons:

**1. Hector Martin - Asahi Project Lead:**

Hector Martin, widely known as "marcan," spearheads the Asahi project. With over 15 years of experience in reverse engineering and development, he specializes in porting Linux to undocumented or closed devices.
