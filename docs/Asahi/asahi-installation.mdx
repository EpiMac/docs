...
- Type 'y' after the system freezing note (it's completely normal don't worry)
- Wait for the partitioning process to end
- Type 'Enter' after partitioning is done
- Type 'f' to install Asahi Linux into the newly allocated free space

![partition-validate](./img/install/partition-validate.png)
:::info
If you can see the newly allocated space (see the yellow rectangle above), then the partitioning
process
occurred without error.
:::

- Choose the OS you want to install by pressing the corresponding key
- Type 'Enter' in order to use all available free space for Asahi Linux
...
- Enter macOS admin password
- If you want to improve Asahi Linux, type 'y' to report your install, otherwise `n`
- Type `Enter` to reboot your computer
...
:::note
If you want this part to be detailed, please open an issue [here](https://github.com/EpiMac/docs/issues)
or ask it on our [Discord](https://epimac.org/discord)
:::

- After booting into Asahi Fedora, follow the installation process like a
...
sudo pacman -Syyu
```
You can find more information about the package manager on [Arch Linux wiki](https://wiki.archlinux.org/title/pacman)
:::

If you want to digg in more into Asahi Linux and be part of that community,
feel free to participate in the project by joining and contributing to the
[GitHub Repository](https://github.com/AsahiLinux)

**Good Job, You have successfully installed Asahi Linux !**
