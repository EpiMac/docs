...
## Importante Notice : Features limitations
...
## Requirements
There is the requirements in order to install Asahi Linux :
- Apple Silicon chipset like M1, M2 or M3 family (all supported devices
[here](https://github.com/AsahiLinux/docs/wiki/Devices))
- macOS 12.3 or later (Admin User)
...
:::info
Contrary to standard OS installation, Asahi Linux doesn't require any ISO
file to USB sticks manipulation
:::

:::caution
Do not forget to do some data backup before installing Asahi Linux
even though the installer will not erase your macOS partition but as we
always say : "You can never be too cautious"
:::
...
- After some OS Information is displayed, enter 'r' to resize an existing
...
- **Good Job ! You erased Asahi Linux successfully !**